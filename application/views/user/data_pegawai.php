...
<head>
  ...
  <link href="<?=base_url()?>assets/components/vendor/owl.carousel/owl.carousel.min.css" rel="stylesheet">
...
<body>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active drop-down"><a href="#datapasar">DATA PASAR</a>
            <ul>
              <li><a href="#data_pegawai">Data Pegawai</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
          <img src="assets/components/icon/pegawai.svg" class="img-fluid animated" width="80%" alt="">
        </div>
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Data Pegawai</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Informasi mengenai pegawai <br>Unit Pelaksana Teknis Daerah Pasar Jatirogo.</h2>
        </div>
      </div>
    </div>
  ...
  <main id="main">
    <!-- ======= data pegawai ======= -->
    <section id="data_pegawai" class="datapasar">
      <div class="container">
