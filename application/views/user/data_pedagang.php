...
<head>
  ...
  <link href="<?=base_url()?>assets/components/vendor/owl.carouse/owl.carousel.min.css" rel="stylesheet">
...
<body>
        ...
        <ul>
          ...
          <li class="active drop-down"><a href="#datapasar">DATA PASAR</a>
            <ul>
              ...
              <li><a href="#data_pedagang">Data Pedagang</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
          <img src="assets/components/icon/pedagang.svg" class="img-fluid animated" width="80%" alt="">
        </div>
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Data Pedagang</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Informasi mengenai pedagang <br>Unit Pelaksana Teknis Daerah Pasar Jatirogo.</h2>
        </div>
      </div>
    </div>
  ...
  <main id="main">
    <!-- ======= data pegawai ======= -->
    <section id="data_pedagang" class="datapasar">
      <div class="container">
                ...
                <table id="table1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $row['NAMA_PDG'] ?></td>
                                <td>
                                  <a href="<?= site_url('u_data_pedagang/details/'.$row['NOIP'])?>" class="btn btn-success btn-flat">Details</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                    </tbody>
